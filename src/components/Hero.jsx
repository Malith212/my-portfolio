...
const Hero = () => {
  return (
    <section className="min-h-screen flex flex-col items-center justify-center bg-[#EDF3F6] px-2" id="hero">
      <motion.div 
      ...
      >
        ...
        <div className="mt-6 sm:mt-8 flex justify-center space-x-4">
          ...
          <motion.a 
            ...
            whileHover={{ scale: 1.2 }}
            whileTap={{ scale: 0.9 }}
            className="text-[#2D3436] text-xl sm:text-2xl hover:text-gray-800 transition-colors duration-300"
          >
            <FaGithub />
          </motion.a>
        </div>
